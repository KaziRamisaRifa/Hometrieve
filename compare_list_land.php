    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto active" href=""><span>Lands</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
        ...
        <div class="card-group">
            <div class="card bg-light">
                ...
                <h6><i class="fa fa-user"></i> Owner Name: <?php echo $land['owner_name']; ?></h6>
                            ...
                            <h6><i class="fa fa-money"></i> Price: <?php echo $land['price']; ?> BDT</h6>
                            <h6><i class="fa fa-pencil"></i> Description: <?php echo $land['description']; ?></h6>
